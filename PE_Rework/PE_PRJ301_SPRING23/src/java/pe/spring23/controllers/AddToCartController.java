...
public class AddToCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            Product newProduct = new Product(productID, productName, description, price, 1);
            cart.addProduct(newProduct);
            request.setAttribute("ADDEDPRODUCT", newProduct);
            String url = MAINCONTROLLER+"?action=Search+all&addAction=add";
